...
Do not copy the full PRD or coding standards into this file. Reference those documents directly.

## Agent skills

### Issue tracker

Use GitHub Issues for task tracking in this repo. See `docs/agents/issue-tracker.md`.
...
Keep this repository as a single-context project. See `docs/agents/domain.md`.
